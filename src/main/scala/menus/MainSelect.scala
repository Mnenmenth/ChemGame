...
object MainSelect {
  ...
  val buttonB = new Image(buttonBTex, (ChemGame.WINDOW_WIDTH * .23).toInt, ChemGame.WINDOW_HEIGHT / 8)
  ...
  val buttonC = new Image(buttonCTex, (ChemGame.WINDOW_WIDTH * .18).toInt, ChemGame.WINDOW_HEIGHT / 8)
  ...
  val buttonD = new Image(buttonDTex, (ChemGame.WINDOW_WIDTH * .26).toInt, ChemGame.WINDOW_HEIGHT / 8)
  ...
  val buttonE = new Image(buttonETex, (ChemGame.WINDOW_WIDTH * .42).toInt, ChemGame.WINDOW_HEIGHT/8)
  ...
  val buttonF = new Image(buttonFTex, (ChemGame.WINDOW_WIDTH*.15).toInt, ChemGame.WINDOW_HEIGHT/8)
